...
<div class="products">
    ...
    <div class="filter-button-group button-group js-radio-button-group">
        ...
        <button data-sort-value="number, country" class="button" data-filter=".america">
            <img src="http://grlindburg.com/stolen/wp-content/uploads/2018/08/world_0001_US_Outline.png">
        </button>
        <button data-sort-value="country, number" class="button" data-filter=".australia">
            <img src="http://grlindburg.com/stolen/wp-content/uploads/2018/08/world_0003_AUS_Outline.png">
        </button>
        <button data-sort-value="country, number" class="button" data-filter=".new-zealand">
            <img src="http://grlindburg.com/stolen/wp-content/uploads/2018/08/world_0002_NZ_Outline.png">
        </button>
    </div>
